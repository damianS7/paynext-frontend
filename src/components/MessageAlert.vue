...
<template>
  <div
    ...
    :class="[
      alert.type === MessageType.INFO && 'bg-blue-100 border-blue-400 text-blue-700',
      alert.type === MessageType.ERROR && 'bg-red-100 border-red-400 text-red-700',
      alert.type === MessageType.SUCCESS && 'bg-green-100 border-green-400 text-green-700',
